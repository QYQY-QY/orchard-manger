  ...
  <div class="page-container">
    ...
    <div class="filter-container">
      <div class="filter-left">
        <div class="filter-item">
          ...
          <el-select
            v-model="filterParams.orchardId"
            placeholder="请选择果园"
            class="filter-select"
            style="width: 180px"
    ...
    <div class="overview-cards">
      <div class="overview-card">
        ...
        <div class="card-info">
          <div class="card-value">{{ stats.collectedImages }}</div>
      ...
      <div class="overview-card">
        ...
        <div class="card-info">
          <div class="card-value">{{ stats.labeledImages }}</div>
...
import { HomeFilled, Refresh, Upload, Document, DataAnalysis, TrendCharts, Loading } from "@element-plus/icons-vue";
...
.recognition-result {
  ...
  .result-crop, .result-weeds, .result-accuracy {
    margin-bottom: 8px;
