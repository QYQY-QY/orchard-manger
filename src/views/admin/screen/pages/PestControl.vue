    ...
    <div class="two-col">
        ...
        <div class="monitor-card">
          ...
          <div class="heatmap-container">
            ...
            <div class="heatmap-grid">
              <div v-for="(cell, index) in heatmapData" :key="index" class="plot-pest" :class="cell.class"
                :title="cell.title">
                {{ cell.label }}
              </div>
            </div>
            <div class="plot-label">
              <span><i class="fas fa-map-marker-alt" style="color:#bf4f2e;"></i> 重灾地块: {{ severeAreas.join(' · ') }}
              </span>
      ...
      <div class="right-panel">
        ...
        <div class="task-card">
          ...
          <div class="task-progress">
            <div v-for="(task, index) in taskData" :key="index" class="progress-item">
              ...
              <div class="bar-bg">
                <div class="bar-fill" :style="{ width: task.percentage, background: task.color }"></div>
              </div>
            </div>
          </div>
          <div class="coverage-badge">
            <i class="fas fa-check-circle" style="color:#2c9c5e;"></i> 防控覆盖率 {{ controlCoverage }}% · 已覆盖{{ coveredAreas
            }}个地块
          </div>
        </div>
        ...
        <div class="chemical-card">
          ...
          <div class="chemical-footer"><i class="fas fa-chart-pie"></i> 按病害配比 · 红蜘蛛用药占比 {{ redSpiderChemicalPercent }}%
          </div>
        </div>
...
.kpi-card.pest2 {
  border-left-color: #c45d32;
}

.kpi-card.pest3 {
  border-left-color: #e6a345;
}

.kpi-card.pest4 {
  border-left-color: #aa4e2c;
}
