...
<template>
  <div class="trace-dashboard">
        ...
        <div class="trace-carousel">
          ...
          <div class="trace-item">
            ...
            <div class="trace-detail">
              ...
              <p>🌱 生长记录: {{ currentYear }}-03-18 施肥 · {{ currentYear }}-03-25 修剪 · {{ currentYear }}-04-02 病虫害防控</p>
      ...
      <div>
        ...
        <div class="right-card">
          ...
          <div class="sync-status">
            ...
            <span>最新同步 {{ currentYear }}-{{ currentMonth }}-{{ currentDay }} {{ currentHour }}:{{ currentMinute }}</span>
          </div>
          <div class="sync-details">
            <div v-for="(item, index) in syncData" :key="index" class="data-row">
              <span>{{ item.platform }}</span>
              <span>{{ item.status }} {{ currentYear }}-{{ currentMonth }}-{{ currentDay }} {{ currentHour }}:{{ currentMinute }}</span>
            </div>
        ...
        <!-- 最新同步日志 -->
        <div class="log-card">
          <div class="section-title" style="font-size:1.1rem;"><i class="fas fa-history"></i> 最新同步日志 (更新于 {{ currentYear }}-{{ currentMonth }}-{{ currentDay }} {{ currentHour }}:{{ currentMinute }})</div>
    ...
    <div class="micro-data">
      ...
      <span>📡 同步成功率99.8% 最新{{ currentYear }}-{{ currentMonth }}-{{ currentDay }}</span>
