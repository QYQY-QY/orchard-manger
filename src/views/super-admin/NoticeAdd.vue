<template>
  ...
  >
    ...
    <el-form-item class="btn-group">
      ...
      <el-button 
        @click="resetForm"
        style="border-radius: 8px; padding: 10px 40px; font-size: 16px; margin-left: 20px;"
        size="large"
      >
        重置
      </el-button>
...
const senderName = userStore.user.name || userStore.user.username || '超级管理员'
